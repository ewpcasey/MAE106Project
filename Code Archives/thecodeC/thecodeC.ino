...
//and the final desired pulse count to control where are robot
//would go. We found the values we ran with using testing and a 
//feed forward model.
...
void loop(){
  ...
  //retraction are ideal for distance.
  if (counter >= 200){
